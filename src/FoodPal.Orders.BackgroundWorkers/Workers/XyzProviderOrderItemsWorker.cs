...
namespace FoodPal.Orders.BackgroundWorkers.Workers
{
	...
	{
		public XyzProviderOrderItemsWorker(ILogger<KfcProviderOrderItemsWorker> logger, IMessageBroker messageBroker, IMessageHandlerFactory messageHandlerFactory, IQueueNameProvider queueNameProvider) : base(logger, messageBroker, messageHandlerFactory, queueNameProvider)
		{
		}
